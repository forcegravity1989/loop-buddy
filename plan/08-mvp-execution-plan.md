...
| **S1 · 归属反转** | ✅ plan/20 落地(2026-08-05) | 查询收窄 R1-R5 + AdoptIntoProject + by-id 记账;偏差如实记 plan/20 §6 |
| **P2 · 项目自带套件** | ◐ 五角色副本已落(plan/20 W1) | 出生即种 + Boot 补种;③体检 ④晨间建单 ⑤三指标仍未做;剧本复制被代码正本现铸取代(plan/20 §6-1)|
| M4 · 端到端验收(原 plan/06 §8 称 M3,本文起统一叫 M4) | ◐ 集成启动证明 | 全部已交付件集成启动无 panic(深链 Progress,stderr [BW_OPEN]) |
