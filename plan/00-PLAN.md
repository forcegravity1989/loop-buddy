...
> ⚠️ **历史档案(2026-08-05 标注)**:本文是最初的总路线图。其中的七控制点阶段模型、「我们 vs 同事团队」双团队分工、P0-P3/M1-M2 里程碑划分,均已被后续演进取代——现状以 `plan/06`(设计事实源)、`plan/07`(产品命题)、`plan/08`(执行计划)为准,导读见 `plan/README.md`。仍然有效的部分:§6 设计系统 token(CLAUDE.md 至今引用)。读本文是为了理解早期取舍,别当现状。
