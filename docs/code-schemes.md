...
| **V1-TermRefactor1–5** | `docs/v1-prototype/issue2-terminal-conversation-refactor.md` §10 | 终端会话重构:1 数据模型 / 2 底座(PTY+路由+xterm+尺寸) / 3 并发切卡 / 4 重启恢复 / 5 咨询态。接续窗口按 §10.1 产品体感切分(非原工程五段) | 1–2 已落地,3–5 进行中 |
