...
| **V1-TermClose1–3** | `docs/v1-prototype/issue2-all-issues-terminal-runs.md` | 终端会话重构收口:1 路由+prompt(所有 issue ▶跑 走终端、issue 内容作位置 prompt、蒸馏/目录并入系统提示词) / 2 删老路径+UI 门控 / 3 examples+文档 | 1 已落地,2–3 进行中 |
