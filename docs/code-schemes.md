...
| **V4-待拍-01–28** | `docs/v4-prototype/mvp-blueprint-draft.md` §11 | V4 MVP 全貌草案的决策项编号(两轮用户反馈 22 条 + 高保真期新增 23 + 2026-08-19 内部专家评审新增 24–28:映射三列 / 看板拖拽只排期 / 项目群 / 老项目回填 / 易用性守则);正文里写作「待拍-NN」 | 已定,随草案转作数 |
