...
> ⚠️ **历史档案(Open Design 内嵌预研记录,2026-08-20 归档)**。记录的是 2026-08-13 对本机 Open Design 的穿刺预研(能不能嵌界面、能不能带 skill/提示词进去),该内嵌能力已落地(代号 V3-OD-embed,见 `docs/code-schemes.md`)。产品现状以仓根 `CLAUDE.md` 为准。
