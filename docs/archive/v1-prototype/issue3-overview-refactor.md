...
- 纪律:`CLAUDE.md`、`docs/guide/填写规范.md`、`.claude/skills/buddy-feature-dev/SKILL.md`(功能) / `.claude/skills/buddy-bugfix/SKILL.md`(缺陷);旧名 `v1-product-delivery` 已归档跳转。`plan/18-step3-metric-loop-tie-up.md`。
