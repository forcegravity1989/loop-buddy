...
> ⚠️ **历史档案(V3-use-fix 创建流列仓 + Claude 探测设计事实源,2026-08-20 归档)**。记录的是同事用 V3 时撞到的安装器/探测、创建流列仓与搜索、程序图标等问题的设计与决议,已本轮落地(见 `docs/code-schemes.md` V3-use-fix)。产品现状以仓根 `CLAUDE.md` 与 `docs/releases.md` 为准。
