...
> **V2 实施进度**:V2-①(调度简化)已实现;V2-② Phase A(多人闭环)/B(回填)/C(总览折线)与 **V2-②-I**(仓平台 open Issue 读回本地)已落地。所有 V2 commit 已随 `v3` 分支经 PR #99 合入 `main`(2026-08-13;写作时曾标「未 push」,2026-08-17 更正)。
