...
| [design/](design/) | **详细设计稿**（第一版，2026-08-19 夜）：[README](design/README.md) 是目录 + 七节模板；01 架构与模块管控 · 02 数据与文件格式 · 03 规范铺底与老项目回填 · 04 开工工具与 workflow · 05 会话屏 · 06 计划屏 · 07 通知与项目群 · 08 总览推导 · 09 运作活剧本 · 10 验收与 E2E · 11 知识库；`00-handshake.md` 是二次握手清单（顶部是用户 2026-08-20 的回复与处置），`REVIEW-2026-08-19.md` 是交叉复核与开放问题汇总 | **第五轮已按用户回复同步，待用户整体复核**；不改 crates/，复核后开工 |
