...
drag_scope = "scheduling_only"    # 拖拽只用于排期(待拍-25);别的列拖拽提示用按钮
```
...
| 运作活②资产盘点与代码微重构 2026-W33 | 评审中 | 定时(周五 20:00)自动建并自动开工,等人合入 |
...
<!-- 由运作活②的 workflow 在 MR 里追加,格式细节见 09-ops-workflows.md -->
- 新增文档 3 篇,均已登记进知识库资产页
- `docs/plan/`、`docs/releases.md` 齐全
- 本周未发现超 1500 行的文件,微重构:无
```
